...
{
    /// <summary>
    ///     A graph which displays the distribution of tone in a series of <see cref="HitEvent" />s.
    /// </summary>
    public class HitEventToneDistributionGraph : CompositeDrawable
    {
        /// <summary>
        ...
        public HitEventToneDistributionGraph(IReadOnlyList<HitEvent> hitEvents)
        {
            this.hitEvents = hitEvents.Where(e => e.HitObject.HitWindows is not HitWindows.EmptyHitWindows && e.Result.IsHit()).ToList();
        }
