...
{
    [Resolved]
    private IStageHitObjectRunner? commandRunner { get; set; }
    ...
    protected sealed override double InitialLifetimeOffset
        => commandRunner?.GetPreemptTime(this) ?? base.InitialLifetimeOffset;
    ...
    {
        commandRunner?.UpdateInitialTransforms(this);
    }

    protected override void UpdateStartTimeStateTransforms()
    {
        commandRunner?.UpdateStartTimeStateTransforms(this);
    }

    protected override void UpdateHitStateTransforms(ArmedState state)
    {
        commandRunner?.UpdateHitStateTransforms(this, state);
    }
}
